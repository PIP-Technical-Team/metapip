...
<!-- badges: start -->
[![codecov](https://codecov.io/gh/PIP-Technical-Team/metapip/branch/complete-doc-update/graph/badge.svg?token=5DMKVN16NM)](https://codecov.io/gh/PIP-Technical-Team/metapip)
<!-- badges: end -->
...
This is functionally equivalent to `options(metapip.custom_default_branch = list(pipr_branch = "main", pipapi_branch = "DEV_v3"))`.
