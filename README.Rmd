...
Since `metapip` works with Github API a lot it is required to have a github token in your environment. You can generate a token for yourself from [here](https://github.com/settings/tokens) and set it as an environment variable as shown below.
